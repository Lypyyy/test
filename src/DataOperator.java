...
public class DataOperator {
	...
	public void connect(){
		try {
			String connectString = "jdbc:mysql://localhost:3306/mybooks?serverTimezone=GMT%2B8&verifyServerCertificate=false&useSSL=false";
			con = DriverManager.getConnection(connectString, "root", "123");
	...
	public void addSuperUser(){ //如果表users为空，添加admin用户
		try {
			...
			if (!rs.next()) {
				...
				//String password = MD5.GetMD5Code("123");
				//取消加密
				String password = "123";
